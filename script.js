$(function () {
  let listMusic = document.querySelector("#list-album");
  ...
  let songs = [
    ...
    },
    {
      ...
      url: "Musics/gianhuanhlangim.mp3",
      picture:
        "https://raw.githubusercontent.com/himalayasingh/music-player-1/master/img/_1.jpg",
    },
    {
      ...
      url: "Musics/kedientinvaotinhyeu.mp3",
      picture:
        "https://raw.githubusercontent.com/himalayasingh/music-player-1/master/img/_1.jpg",
    },
    {
    ...
    },
    {
      ...
      url: "Musics/loinoidieutrenmoiem.mp3",
      picture:
        "https://raw.githubusercontent.com/himalayasingh/music-player-1/master/img/_1.jpg",
    },
    {
  ...
  let lists = document.querySelectorAll("#list-album > li");
  console.log(lists);
  function shuffle(a) {
    let j, x, i;
